...
LIGHTRED='\e[1;91m'
BINGUS='\e[0;101m'
echo -e "${BINGUS}BADHRA v1. created by Dumpoothiri https://github.com/dumpoothiri${NC}"
echo -e "${LIGHTRED}\nNOTE: THIS PROGRAM IS FOR EDUCATIONAL USE ONLY. USERS ARE FULLY RESPONSIBLE FOR ITS APPLICATION. THE CREATOR(S) OF DUMPO ARE NOT LIABLE IN ANY WAY SHAPE OR FORM FOR ANY POTENTIAL MISUSE OR \nILLEGAL ACTIVITY.\n${NC}"
